...
export function ChatInterface() {
  ...
  const getAuthToken = useCallback(async () => {
    try {
      ...
      // If not found in localStorage, get it from Auth0
  ...
  }, [getAccessTokenSilently, cachedAuthToken])
  ...
  const { messages, input, handleInputChange, handleSubmit, isLoading, setMessages } = useChat({
    ...
    body: {
      ...
      threadId: threadId,
      token: cachedAuthToken, // Include the token in the request body as a fallback
    },
